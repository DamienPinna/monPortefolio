...
typewriter
  ...
  .changeDelay(70)
  .typeString(
    "<strong>, Développeur</strong><span style='color: #ea39ff;'> HTML</span> ?"
  )
  .pauseFor(1000)
  .deleteChars(6)
 ...
 * Vague 4
 */
const itemPortfolioVague4 = document.querySelectorAll(".vague4");

const tlPortfolioVague4 = new TimelineMax();

tlPortfolioVague4.staggerFrom(
  itemPortfolioVague4,
  1,
  { opacity: 0 },
  0.2,
...
const scenePortfolioVague4 = new ScrollMagic.Scene({
  triggerElement: itemPortfolioVague3,
  triggerHook: 0.2,
  reverse: false,
})
  .setTween(tlPortfolioVague4)
  // .addIndicators()
  .addTo(controller);
 ...
 * Vague 5
 */
// const itemPortfolioVague5 = document.querySelectorAll(".vague5");

// const tlPortfolioVague5 = new TimelineMax();

// tlPortfolioVague5.staggerFrom(
//   itemPortfolioVague5,
//   1,
//   { opacity: 0 },
//   0.2,
...
// const scenePortfolioVague5 = new ScrollMagic.Scene({
//   triggerElement: itemPortfolioVague4,
//   triggerHook: 0.2,
//   reverse: false,
// })
//   .setTween(tlPortfolioVague5)
//   // .addIndicators()
//   .addTo(controller);
